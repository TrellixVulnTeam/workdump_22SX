...
\begin{illustration}
	Note that 32 is relatively prime to 17. We can verify that $32^{\phi(17)} \equiv 32^{16} \equiv -2^{16} \equiv (-2^4)^4 \equiv 16^4 \equiv -1^4 \equiv 1 \mod 17$.
\end{illustration}
...
\noindent Recall that we have chosen $M$ to be relatively prime to $n$, and so it must also be relatively prime to $p$. Thus, we can apply \ref{euler} to obtain
\begin{equation}
