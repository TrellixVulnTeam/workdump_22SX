...
\section{Determinants} la_pdf-p:49,215
...
\begin{enumerate}
  \lit $(\alpha \in \mathcal{S}_n) \iff (\alpha = \tau \circ (\tau^{-1} \circ \alpha) \in \mathcal{S}_n) \iff (\alpha \in \{\tau \circ \sigma \st \sigma \in \mathcal{S}_n\})$
  \lit $(\alpha \in \mathcal{S}_n) \iff (\alpha = (\alpha \circ \tau^{-1}) \circ \tau) \in \mathcal{S}_n) \iff (\alpha \in \{\sigma \circ \tau \st \sigma \in \mathcal{S}_n\})$
  \lit $(\alpha \in \mathcal{S}_n) \iff (\alpha = (\alpha^{-1})^{-1} \in \mathcal{S}_n) \iff (\alpha \in \{\sigma^{-1} \st \sigma \in \mathcal{S}_n\})$
...
$Inversions[n(\sigma), \sigma] \abr (\sigma \in \mathcal{S}_n) \land (n(\sigma) = |\{(i, j) \st (i < j) \land (\sigma(i) > \sigma(j))\}| = \sum_{i = 1}^{n}(|\{(i, j) \st (\sigma(i) > \sigma(j)) \land (i < j \leq n)\}|))$ \\
$Transposition[\tau, m, r] \abr (\tau \in \mathcal{S}_n) \land (\forall_{i \in \mathbb{N}_{1, n}}((i \notin \{m, r\}) \implies (\tau(i) = i))) \land (\tau(m) = r) \land (\tau(r) = m)$ \\
