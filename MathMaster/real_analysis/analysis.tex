...
\begin{enumerate}
  \lit $CyclicGroup[G, *]$ \pipe $\exists_{g \in G}(CyclicSubgroup[G, g, G, *])$ \pipe $\exists_{g_0 \in G}(G = <g_0> = \{{g_0}^n \st n \in \mathbb{Z}\})$
  \lit $ExpMapsExp$ \pipe $h \in im_\phi \iff \exists_{g \in G}(h = \phi(g)) \iff \exists_{n \in \mathbb{Z}}(h = \phi({g_0}^n)) \iff \exists_{n \in \mathbb{Z}}(h = \phi(g_0)^n)$ \pipe $Generator[\phi(g_0), im_\phi, \diamond]$
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
      ...
      \lit $(Injective[\phi, G, H]) \land (\phi(g) = \phi(e_G))$ \pipe $g = e_G$ \pipe $g \in \{e_G\}$
    \end{enumerate}
  ...
  \begin{enumerate}
    ...
    \end{enumerate}
    \lit $((g_1, g_2 \in G) \land (\phi(g_1) = \phi(g_2))) \implies (g_1 = g_2)$ \pipe $Injective[\phi, G, H]$ \pipe $Monomorphism[\phi, G, *, H, \diamond]$
  \end{enumerate}
  \lit $(ker_\phi = \{e_G\}) \implies (Monomorphism[\phi, G, *, H, \diamond])$
  \lit $((Monomorphism[\phi, G, *, H, \diamond]) \implies (ker_\phi = \{e_G\})) \land ((ker_\phi = \{e_G\}) \implies (Monomorphism[\phi, G, *, H, \diamond]))$
  \lit $(Monomorphism[\phi, G, *, H, \diamond]) \iff (ker_\phi = \{e_G\})$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\

$KerCountsMapSameEl \abr ((Homomorphism[\phi, G, *, H, \diamond]) \land (g \in G)) \implies ((ker_\phi) g = \{x \in G \st \phi(x) = \phi(g)\})$
\begin{enumerate}
  ...
  \lit $(\phi(x) = \phi(g)) \implies \ldots$
  \begin{enumerate}
    \lit $e_H = \phi(x) \diamond \phi(g)^{-1} = \phi(x) \diamond \phi(g^{-1)} = \phi(x * g^{-1)}$ \pipe $x * g^{-1} \in ker_\phi$ \pipe $x \in (ker_\phi) g$
  \end{enumerate}
  \lit $(\phi(x) = \phi(g)) \implies (x \in (ker_\phi) g)$ \pipe $\{x \in G \st \phi(x) = \phi(g)\} \subseteq (ker_\phi) g$
...
$KerImPartitionsG \abr (Homomorphism[\phi, G, *, H, \diamond]) \implies (o(G) = o(ker_\phi) o(im_\phi))$
\begin{enumerate}
...
$ImageDividesGH \abr (Homomorphism[\phi, G, *, H, \diamond]) \implies ((Divides[o(im_\phi), o(G)]) \land (Divides[o(im_\phi), o(H)]))$
\begin{enumerate}
...
$QuotientMap[\bar{\phi}, H, G, *] \abr (NormalSubgroup[H, G, *]) \land (Func[\bar{\phi}, G, *, G / H, \bbin{*}]) \land (\forall_{g \in G}(\bar{\phi}(g) = H g))$ \\
...
\begin{enumerate}
  \lit $\psi \abr \{\langle ker_\phi g, \phi(g) \rangle \in (G / ker_\phi \times im_\phi) \st g \in G\}$
  ...
  \end{enumerate}
  \lit $(ker_\phi g, ker_\phi h \in G / ker_\phi) \implies (\psi(ker_\phi g \bbin{*} ker_\phi h) = \psi(ker_\phi g) \diamond \psi(ker_\phi h))$ \cont
  \lit \cont $\forall_{ker_\phi g, ker_\phi h \in G / ker_\phi}(\psi(ker_\phi g \bbin{*} ker_\phi h) = \psi(ker_\phi g) \diamond \psi(ker_\phi h))$
  \lit $(Bij[\psi, G / ker_\phi, im_\phi]) \land (\forall_{ker_\phi g, ker_\phi h \in G / ker_\phi}(\psi(ker_\phi g {\bbin{*}} ker_\phi h) = \psi(ker_\phi g) \diamond \psi(ker_\phi h)))$ \pipe $Isomorphism[\psi, G / ker_\phi, \bbin{*}, im_\phi, \diamond]$
...
\begin{enumerate}
  ...
  \lit $\phi \abr \{\langle h, h N \rangle \in (H \times (H N) / N) \st h \in H\}$
  ...
  \lit $(FirstIsoThm) \land (Homomorphism[\phi, H, *, (H N) / N, \bbin{*}])$ \pipe $Isomorphic[H / ker_\phi, \bbin{*}, im_\phi, \bbin{*}]$
...
\end{array}\right)$
\begin{enumerate}
  \lit $\phi \abr \{\langle g K, g H \rangle \in ((G / K) \times (G / H)) \st g \in G\}$
  ...
  \lit $(g H \in (G / H)) \implies \ldots$
  \begin{enumerate}
    \lit $g \in G$ \pipe $g K \in (G / K)$
    \lit $g H = \phi(g K)$
    \lit $(g K \in (G / K)) \land (g H = \phi(g K))$ \pipe $\exists_{g K \in (G / K)}(g H = \phi(g K))$
  \end{enumerate}
  \lit $(g H \in (G / H)) \implies (\exists_{g K \in (G / K)}(g H = \phi(g K)))$ \pipe $\forall_{g H \in (G / H)} \exists_{g K \in (G / K)}(g H = \phi(g K))$ \pipe $Surj[\phi, G / K, G / H]$ \pipe $im_\phi = G / H$
  \lit $(FirstIsoThm) \land (Homomorphism[\phi, G / K, \bbin{*}, G / H, \bbin{*}])$ \pipe $Isomorphic[(G / K) / ker_\phi, \bbin{*}, im_\phi, \bbin{*}]$
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Linear Algebra} % ([a-zA-Z]+?)\((.+?)\)    $1[$2]
...
$RngSurjective \abr \forall_{L, V, W}((Ran[rng_L, L, V, +_v, *_v, W, +_w, *_w]) \implies ((Surjective[L, V, W]) \iff (rng_L = W)))$
\begin{enumerate}
  \lit $(SurjEquiv) \land (rng(L) = rng_L)$ \pipe $(Surjective[L, V, W]) \iff (rng_L = W)$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
...
$InjectiveSurjectiveEqualDim \abr \forall_{T, V, W}\left(\begin{array}{ll}
  ((LinTrans[T, V, +_v, *_v, W, +_w, *_w]) \land (Dim[V] = Dim[W]) \land (Injective[T, V, W])) \hfill \implies \hfill \\
  (Surjective[T, V, W])
\end{array}\right)$
\begin{enumerate}
...
$SurjectiveInjectiveEqualDim \abr \forall_{T, V, W}\left(\begin{array}{ll}
  ((LinTrans[T, V, +_v, *_v, W, +_w, *_w]) \land (Dim[V] = Dim[W]) \land (Surjective[T, V, W])) \hfill \implies \hfill \\
  (Injective[T, V, W])
\end{array}\right)$
\begin{enumerate}
...
$SmallerMapNotInjective \abr \forall_{T, V, W}(((LinTrans[T, V, +_v, *_v, W, +_w, *_w]) \land (Dim[V] > Dim[W])) \implies (\lnot Injective[T, V, W]))$
\begin{enumerate}
...
$LargerMapNotSurjective \abr \forall_{T, V, W}(((LinTrans[T, V, +_v, *_v, W, +_w, *_w]) \land (Dim[V] < Dim[W])) \implies (\lnot Surjective[T, V, W]))$
\begin{enumerate}
...
$InvertibleBijectiveEquiv \abr \forall_{L}((LTInvertible[L, V, +_v, *_v, W, +_w, *_w]) \iff ((Injective[L, V, W]) \land (Surjective[L, V, W])))$
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \end{enumerate}
    \lit $(L(u) = L(w)) \implies (u = w)$ \pipe $\forall_{u, w}((L(u) = L(w)) \implies (u = w))$ \pipe $Injective[L, V, W]$
    ...
    \end{enumerate}
    \lit $(w \in W) \implies (\exists_{v \in V}(w = (L(v))))$ \pipe $\forall_{w \in W} \exists_{v \in V}(w = L(v))$ \pipe $Surjective[L, V, W]$
    \lit $(Injective[L, V, W]) \land (Surjective[L, V, W])$
  \end{enumerate}
  \lit $(LTInvertible[L, V, +_v, *_v, W, +_w, *_w]) \implies ((Injective[L, V, W]) \land (Surjective[L, V, W]))$
  \lit $((Injective[L, V, W]) \land (Surjective[L, V, W])) \implies \ldots$
  \begin{enumerate}
    \lit $(Injective[L, V, W]) \land (Surjective[L, V, W])$ \pipe $\forall_{w \in W} \exists!_{v \in V}(w = L(v))$
    ...
    \begin{enumerate}
      ...
      \lit $(Injective[L, V, W]) \land (L(S(w_1) + S(w_2)) = L(S(w_1 + w_2)))$ \pipe $S(w_1) + S(w_2) = S(w_1 + w_2)$
    \end{enumerate}
    ...
    \begin{enumerate}
      ...
      \lit $(Injective[L, V, W]) \land (L(r * S(w)) = L(S(r * w)))$ \pipe $r * S(w) = S(r * w)$
    \end{enumerate}
  ...
  \end{enumerate}
  \lit $((Injective[L, V, W]) \land (Surjective[L, V, W])) \implies (LTInvertible[L, V, +_v, *_v, W, +_w, *_w])$
  \lit $(LTInvertible[L, V, +_v, *_v, W, +_w, *_w]) \iff ((Injective[L, V, W]) \land (Surjective[L, V, W]))$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
...
$IntPermSetDecomp \abr (IntPermSet[\mathcal{S}_n, n]) \land (Perm[\tau, \mathbb{N}_{1, n}]) \implies (\mathcal{S}_n = \{\tau \circ \sigma \st \sigma \in \mathcal{S}_n\} = \{\sigma \circ \tau \st \sigma \in \mathcal{S}_n\})$
\begin{enumerate}
  \lit $(\sigma \in \mathcal{S}_n) \iff ()$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 


% TODO: script that updates completions based on completions snippet in a file!!!
%############################################################################
% \left(\begin{array}{ll}
