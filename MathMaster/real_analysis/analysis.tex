...
\begin{enumerate}
  ...
  \begin{enumerate}
    \lit $(\phi(a) = e_H) \land (\phi(b) = e_H)$ \pipe $e_H = e_H \diamond e_H = \phi(a) \diamond \phi(b) = \phi(a * b)$ \pipe $a * b \in ker_\phi$
  \end{enumerate}
...
$MapsToSameEl \abr (ker_\phi) g = \{x \in G | \phi(x) = \phi(g)\}$
\begin{enumerate}
  ...
  \end{enumerate}
  \lit $(\phi(x) = \phi(g)) \implies (x \in (ker_\phi) g)$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 

$MapsToSameElMultiplicity \abr ((|G| = n) \land (|ker_\phi| = m) \land (|im_\phi| = r)) \implies (n = m r)$
\begin{enumerate}
  \lit TODO
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 

$ImageDividesGH \abr (|im_\phi| = r) \implies ((Divides[r, o(G)]) \land (Divides[r, o(H)]))$
\begin{enumerate}
  \lit $MapsToSameElMultiplicity$ \pipe $Divides[r, o(G)]$
  \lit $LagrangeTheorem$ \pipe $Divides[r, o(H)]$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
...
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
**Note: why is this both sound and awkward at the same time \\
...
$ConjugateOrder \abr (h \sim^* g) \implies (o(h) = o(g))$
\begin{enumerate}
  \lit $\exists_{c \in G}(g = c^{-1} h c)$ \pipe $e = g^{o(g)} = (c^{-1} h c)^{o(g)} = c^{-1} h^{o(g)} c$ \pipe $e = c^{-1} h^{o(g)} c$ \pipe $h^{o(g)} = e$ \pipe $o(h) = o(g)$
  \lit TODO: contradiction if $h^m = e$ for some $m < o(g)$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
