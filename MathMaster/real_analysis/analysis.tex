...
$Center[Z(G), G, *] \abr (Group[G, *]) \land (Z(G) = \cap_{g \in G}(C(g)))$ \\
...
$NormalSubgroup[H, G, *] \abr (Subgroup[H, G, *]) \land (\forall_{g \in G}(g H = H g))$ \\

$CenterNormalSubgroup \abr NormalSubgroup[Z(G), G, *]$
\begin{enumerate}
  \lit $SubgroupCenter$ \pipe $Subgroup[Z(G), G, *]$
  \lit $(g \in G) \implies \ldots$
  \begin{enumerate}
    \lit $g Z(G) = \{g * a | \forall_{b \in G}(a * b = b * a)\} = \{a * g | \forall_{b \in G}(a * b = b * a)\} = Z(G) g$ \pipe $g Z(G) = Z(G) g$
  \end{enumerate}
  \lit $(g \in G) \implies (g Z(G) = Z(G) g)$ \pipe $\forall_{g \in G}(g Z(G) = Z(G) g)$
  \lit $(Subgroup[Z(G), G, *]) \land (\forall_{g \in G}(g Z(G) = Z(G) g))$ \pipe $NormalSubgroup[Z(G), G, *]$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 

$UnionConjugacyClassesNormalSubgroup \abr 12313$
\begin{enumerate}
  \lit TODO
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 

$IndexImpliesSubgroup \abr 123123$
\begin{enumerate}
  \lit TODO
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
