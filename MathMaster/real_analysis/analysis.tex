...
\begin{enumerate}
  ...
  \begin{enumerate}
     ...
     \begin{enumerate}
       ...
       \lit $\rf{LUB}(\alpha_0, A, \mathbb{R}, <) \land \alpha_0 - x < \alpha_0$ \pipe $\lnot \rf{UpperBound}(\alpha_0 - x, A, \mathbb{R}, <)$ \pipe $\exists_{a \in A}(\alpha_0 - x < a)$ \pipe $a_0 choice(\{a \in A | \alpha_0 - x < a\})$
       \lit $\exists_{m \in \mathbb{N}^+}(m x = a_0)$ ...
       $a \in \alpha_0 \iff \exists_{123123}$
     \end{enumerate}
...
\wff{QDensityInR} $\forall_{x, y \in \mathbb{R}}\pr{x < y \implies \exists_{p \in \mathbb{Q}}(x < p < y)}$
\begin{enumerate}
  \lit 123123
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
