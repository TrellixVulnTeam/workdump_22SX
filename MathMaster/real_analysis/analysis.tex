...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \lit $\rf{UpperBound}(\beta_0, A, \mathbb{R}, <_{\mathbb{R}})$ \pipe $\forall_{\alpha \in A}(\alpha \leq_{\mathbb{R}} \beta_0)$ \pipe $\forall_{\alpha \in A}(\alpha \subseteq \beta_0)$
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \lit $\emptyset \neq \alpha \subseteq \mathbb{Q} \land \emptyset \neq \alpha \subseteq \mathbb{Q}$
    \lit $\exists_{a}(a \in \alpha) \land \exists_{b}(b \in \beta)$ \pipe $a_0 \abr choice(\{a | a \in \alpha\}), b_0 \abr choice(\{b | b \in \beta\})$
    \lit $\exists_{x \notin \alpha} \land \exists_{y}(y \notin \beta)$
  \end{enumerate}
