...
\begin{enumerate}
  ...
  \end{enumerate}
  \lit $(x, y \in G) \implies ((x^{-1} g x = y^{-1} g y) \iff (C(g) x = C(g) y))$
  \lit $(Func[\phi, C_g, G : C(g)]) \land (Inj[\phi, C_g, G : C(g)]) \land (Surj[\phi, C_g, G : C(g)])$ \pipe $Bij[\phi, C_g, G : C(g)]$
...
$FactorMul[\bar{*}, H, G, *] \abr (Subgroup[H, G, *]) \land (\forall_{x, y \in G}(H x \bar{*} H y = \{h_1 x h_2 y | h_1, h_2 \in H\}))$ \\
...
$QuotientGroup \abr \left(\begin{array}{ll}
  ((NormalSubgroup[H, G, *]) \hfill \land \hfill (QuotientSet[G / H, H, G, *]) \hfill \land \hfill (FactorMul[\bar{*}, x, y, H, G, *])) \hfill \implies \hfill \\
  (Group[G / H, \bar{*}])
\end{array}\right)$
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \lit $(z \in H x \bar{*} H y) \iff (\exists_{h_1, h_2 \in H}(z = h_1 x h_2 y)) \iff (\exists_{h_3 \in H}(z = h_3 x y)) \iff (z \in H x y)$ \pipe $H x \bar{*} H y = H x y$
  ...
  \end{enumerate}
  \lit $(H x, H y \in G / H) \implies (\exists!_{H x y \in G / H}(H x \bar{*} H y = H x y))$ \pipe $Func[\bar{*}, G / H, G / H]$
  ...
  \end{enumerate}
  \lit $(H x, H y, H z \in G / H) \implies ((H x \bar{*} H y) \bar{*} H z = H x \bar{*} (H y \bar{*} H z))$ \pipe $\forall_{a, b, c \in G / H}((a \bar{*} b) \bar{*} c = a \bar{*} (b \bar{*} c))$
  \lit $(H e \in G / H) \land (\forall_{H x \in G / H}(H x \bar{*} H e = H x e = H x = H e x = H e \bar{*} H x))$ \pipe $\exists_{e \in G / H} \forall_{a \in G / H}(a \bar{*} e = a = e \bar{*} a)$
  ...
  \end{enumerate}
  \lit $(H x \in G / H) \implies (\exists_{H x^{-1} \in G / H}(H x \bar{*} H x^{-1} = H e = H x^{-1} \bar{*} H x))$ \pipe $\forall_{a \in G / H} \exists_{a^{-1} \in G / H}(a \bar{*} a^{-1} = e = a^{-1} \bar{*} a)$
  \lit $(Func[\bar{*}, G / H, G / H]) \land (\forall_{a, b, c \in G / H}((a \bar{*} b) \bar{*} c = a \bar{*} (b \bar{*} c))) \land (\exists_{e \in G / H} \forall_{a \in G / H}(a \bar{*} e = a = e \bar{*} a)) \land$ \cont
  \lit \cont $(\forall_{a \in G / H} \exists_{a^{-1} \in G / H}(a \bar{*} a^{-1} = e = a^{-1} \bar{*} a))$ \pipe $Group[G / H, \bar{*}]$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 

$QuotientMap[\bar{\phi}, H, G, *] \abr (NormalSubgroup[H, G, *]) \land (Func[\bar{\phi}, G, *, G / H, \bar{*}]) \land (\forall_{g \in G}(\bar{\phi}(g) = H g))$ \\

$QuotientMapHomo \abr (QuotientMap[\bar{\phi}, H, G, *]) \implies (Homomorphism[\bar{\phi}, G, *, G / H, \bar{*}])$
\begin{enumerate}
  \lit $QuotientMap[\bar{\phi}, H, G, *]$ \pipe $Func[\bar{\phi}, G, *, G / H, \bar{*}]$
  \lit $(x, y \in G) \implies \ldots$
  \begin{enumerate}
    \lit $\bar{\phi}(x * y) = H x y = H x \bar{*} H y = \bar{\phi}(x) \bar{*} \bar{\phi}(y)$ \pipe $\bar{\phi}(x * y) = \bar{\phi}(x) \bar{*} \bar{\phi}(y)$
  \end{enumerate}
  \lit $(x, y \in G) \implies (\bar{\phi}(x * y) = \bar{\phi}(x) \bar{*} \bar{\phi}(y))$ \pipe $\forall_{x, y \in G}(\bar{\phi}(x) \bar{*} \bar{\phi}(y)))$
  \lit $(Func[\bar{\phi}, G, *, G / H, \bar{*}]) \land (\forall_{x, y \in G}(\bar{\phi}(x) \bar{*} \bar{\phi}(y))))$ \pipe $Homomorphism[\bar{\phi}, G, *, G / H, \bar{*}]$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\

$QuotientMapKer \abr (QuotientMap[\bar{\phi}, H, G, *]) \implies (ker_{\bar{\phi}} = H)$
\begin{enumerate}
  \lit $ker_{\bar{\phi}} = \{x \in G | \bar{\phi}(x) = H e\} = \{x \in G | H x = H\} = H$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
CONTHERE The proofs are omitted in these notes but you may refer to Fraleigh, pp. 229-230
$FirstIsoTheorem \abr $
\begin{enumerate}
  \lit TODO
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 

$SecondIsoTheorem \abr $
\begin{enumerate}
  \lit TODO
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
