  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
      ...
      \begin{enumerate}
        ...
        \lit $\forall_{y \in L}\pr{\rf{LowerBound}(y_0, B, S, <)}$ \pipe $\forall_{y \in L} \forall_{x \in B}(y_0 \leq x)$    \ann{\rf{LowerBound}, 1.1.4.2}{1.1.4.10}
        \lit $\forall_{x \in B}\pr{x \in S \land \forall_{y \in L}(y_0 \leq x)}$ \pipe $\forall_{x \in B}\pr{\rf{UpperBound}(x, L, S, <)}$    \ann{\rf{UpperBound}}{}
...
\wff{1IsNot0} $0_{\mathbb{R}} \neq 1_{\mathbb{R}}$    \phantom{TODO}--- \\
\wff{1InR} $1_{\mathbb{R}} \in \mathbb{R}$    \phantom{TODO}--- \\
\wff{FieldMultiplicationClosureOfR} $(\alpha, \beta \in \mathbb{R}) \implies \pr{(\alpha *_{\mathbb{R}} \beta) \in \mathbb{R}}$    \phantom{TODO}--- \\
\wff{FieldMultiplicationCommutativityOfR} $(\alpha, \beta \in \mathbb{R}) \implies (\alpha *_{\mathbb{R}} \beta = \beta *_{\mathbb{R}} \alpha)$    \phantom{TODO}--- \\
\wff{FieldMultiplicationAssociativityOfR} $(\alpha, \beta, \gamma \in \mathbb{R}) \implies \pr{(\alpha *_{\mathbb{R}} \beta) *_{\mathbb{R}} \gamma = \alpha *_{\mathbb{R}} (\beta *_{\mathbb{R}} \gamma)}$    \phantom{TODO}--- \\
\wff{FieldMultiplicationIdentityOfR} $(\alpha \in \mathbb{R}) \implies 1_{\mathbb{R}} *_{\mathbb{R}} \alpha = \alpha$    \phantom{TODO}--- \\
\wff{FieldMultiplicationInverseOfR} $(\alpha \in \mathbb{R}) \implies \exists_{1/\alpha \in \mathbb{R}}\pr{\alpha *_{\mathbb{R}} (1/\alpha) = 1_{\mathbb{R}}}$    \phantom{TODO}--- \\

\wff{FieldDistributativityOfR} $(\alpha, \beta, \gamma \in \mathbb{R}) \implies \gamma *_{\mathbb{R}} (\alpha +_{\mathbb{R}} \beta) = \gamma *_{\mathbb{R}} \alpha + \gamma *_{\mathbb{R}} \beta$    \phantom{TODO}--- \\

\wff{FieldWithR} $\rf{Field}(\mathbb{R}, +_{\mathbb{R}}, *_{\mathbb{R}})$    \phantom{TODO}--- \\
\wff{OrderedFieldWithR} $\rf{OrderedField}(\mathbb{R}, +_{\mathbb{R}}, *_{\mathbb{R}}, <_{\mathbb{R}})$    \phantom{TODO}--- \\

$\df{\mathbb{Q}_{\mathbb{R}}} \abr \{\{r \in \mathbb{Q} | r < q\} | q \in \mathbb{Q}\}$ \\
\wff{QROrderedSubfieldOfR} $\rf{OrderedSubfield}(\mathbb{Q}_{\mathbb{R}}, \mathbb{R}, +_{\mathbb{R}}, *_{\mathbb{R}}, <_{\mathbb{R}})$    \phantom{TODO}--- \\
\wff{QIsomorphicToQR} $\mathbb{Q}_{\mathbb{R}} \simeq \mathbb{Q}$    \phantom{TODO}--- \\
\wff{ExistenceOfR} $\exists_{\mathbb{R}}\pr{\rf{LUBProperty}(\mathbb{R}, <_{\mathbb{R}}) \land \rf{OrderedSubfield}(\mathbb{Q}, \mathbb{R}, +_{\mathbb{R}}, *_{\mathbb{R}}, <_{\mathbb{R}})}$    \phantom{TODO}--- \\
\wff{OrderedFieldR} $\rf{OrderedField}(\mathbb{R}, +_{\mathbb{R}}, *_{\mathbb{R}}, <_{\mathbb{R}})$    \phantom{TODO}--- \\
...
\wff{FieldC} $\rf{Field}(\mathbb{C}, +_{\mathbb{C}}, *_{\mathbb{C}})$    \phantom{TODO}--- \\
\wff{RSubfieldC} $\rf{Subfield}(\mathbb{R}, \mathbb{C}, +, *)$    \phantom{TODO}--- \\

$\df{i} \abr \langle 0, 1 \rangle \in \mathbb{C}$ \\

\wff{iProperty} $i^2 = -1$    \phantom{TODO}--- \\
\wff{CProperty} $(a, b \in \mathbb{R}) \implies (\langle a, b \rangle = a + b i)$    \phantom{TODO}--- \\

$\df{Conjugate}(\overline{a + b i}) \abr a - b i$ \\

\wff{ConjugateProperties} $(w, z \in \mathbb{C}) \implies \ldots$    \phantom{TODO}--- \\
\begin{enumerate}
...
\wff{AbsoluteValueProperties} $(z, w \in \mathbb{C}) \implies \ldots$    \phantom{TODO}--- \\
\begin{enumerate}
  \lit 123123
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
...
$EquivalentSystem() \ldots$

$(A B)^T = B^T A^T$ \\
$Sym(A) \abr A^T = A$ \\
$Skew(A) \abr A^T = -A$ \\

$(B = A + A^T) \implies Sym(B)$ \\
$(B = A - A^T) \implies Skew(B)$ \\
$A = (1/2) (A + A^T) + (1/2) (A - A^T) = Sym(B_1) + Skew(B_2)$ \\

$Invertible(A) \abr \exists_{A^{-1}}(A A^{-1} = I = A^{-1} A)$ \\

$\pr{Invertible(A) \land Invertible(B)} \implies \pr{Invertible(A B) \land (A B)^{-1} = B^{-1} A^{-1}}$ \\
$\pr{Invertible(A)} \implies \pr{Invertible(A^{-1}) \land (A^{-1})^{-1} = A}$ \\
$\pr{Invertible(A)} \implies \pr{Invertible(A^T) \land (A^T)^{-1} = (A^{-1})^T}$ \\

$RREF(A) \abr (Definition 1.18)$ \\
$ElementaryRowOperation(\phi) \abr (Definition 1.19)$ \\
$RowEquivalent(A, B) \abr \exists_{\Phi}(\forall_{\phi \in \Phi}(ElementaryRowOperation(\phi)) \land |\Phi| \in \mathbb{N} \land \Phi(A) = B)$ \\

By Gauss-Jordan Elimination: $NonZero(A) \implies \exists_{B}(RREF(B) \land RowEquivalent(A, B))$ \\

$\pr{A X = B \land C X = D \land RowEquivalent([A|B], [C|D])} \implies \pr{[A X = B] \equiv [C X = D]}$ \\
$\pr{RowEquivalent(A, B)} \implies \pr{[A X = \mathbb{O}] \equiv [B X = \mathbb{O}]}$ \\
