...
$RowOp(\phi, A) \abr (\phi \equiv RowSwap(A)) \lor (\phi \equiv RowScale(A)) \lor (\phi \equiv RowCombine(A))$ \\
$RowOps(\langle \Phi \rangle_1^n, A) \abr \forall_{i < n}(((i = 1) \implies RowOp(\phi_i, A)) \land ((i > 1) \implies RowOps(\langle \Phi \rangle_i^n), \phi_i(A)))$ \\
$RowEquiv(A, B) \abr \exists_{\langle \Phi \rangle_1^n}((RowOps(\langle \Phi \rangle_1^n, A)) \land (\langle \Phi \rangle_1^n(A) = B))$ \\
