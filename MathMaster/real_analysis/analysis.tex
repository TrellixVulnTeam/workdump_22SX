...
$LinComb[c, U, V, +, *] \abr (VectorSpace[V, +, *]) \land (U \subseteq V) \land (n = |U| \in \mathbb{N}) \land (\exists_{\Gamma \in \mathbb{R}^{n}}(c = \sum_{i = 1}^{n}(\gamma_i * u_i)))$ \\
...
$BasisCard \abr \forall_{S, T, V}(((Basis[S, V, +, *]) \land (LinearlyIndependent(T, V, +, *))) \implies (|T| \leq |S|))$
\begin{enumerate}
  ...
  \begin{enumerate}
      ...
      \end{enumerate}
      \lit $(|T| > |S|) \implies (\lnot LinearlyIndependent(T, V, +, *))$ \pipe $(LinearlyIndependent(T, V, +, *)) \implies (|T| \leq |S|)$
   \end{enumerate}
  \lit $((Basis[S, V, +, *]) \land (LinearlyIndependent(T, V, +, *))) \implies (|T| \leq |S|)$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
