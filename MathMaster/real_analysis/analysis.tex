...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \lit $\beta_0 \abr choice\pr{\{\beta | \rf{UpperBound}(\beta, A, \mathbb{R}, <_{\mathbb{R}})\}}$
...
$\df{CompletenessOfR} \abr \exists_{\mathbb{R}}\pr{\rf{LUBProperty}(\mathbb{R}, <_{\mathbb{R}}) \land \rf{OrderedSubfield}(\mathbb{Q}, \mathbb{R}, +_{\mathbb{R}}, *_{\mathbb{R}}, <_{\mathbb{R}})}$    \phantom{TODO}--- \\
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
      ...
      \lit $\pr{\rf{LUBProperty}(\mathbb{R}, <)} \land (\emptyset \neq A \subset \mathbb{R}) \land \pr{\rf{BoundedAbove}(A, \mathbb{R}, <)}$ \pipe $\exists_{\alpha \in \mathbb{R}}\pr{\rf{LUB}(\alpha, A, \mathbb{R}, <)}$ \cont
      \lit \cont $\alpha_0 \abr choice\pr{\{\alpha \in \mathbb{R} | \rf{LUB}(\alpha, A, \mathbb{R}, <)\}}$ \pipe $\rf{LUB}(\alpha_0, A, \mathbb{R}, <)$
      \lit $x > 0$ \pipe $\alpha_0 - x < \alpha_0$
      \lit $(\alpha_0 - x < \alpha_0) \land \pr{\rf{LUB}(\alpha_0, A, \mathbb{R}, <)}$ \pipe $\lnot \rf{UpperBound}(\alpha_0 - x, A, \mathbb{R}, <)$
...
(1.21) \\
$\df{RootLemma1} \abr (0 < a < b) \implies \pr{b^n - a^n \leq (b - a) n b^{n - 1}}$
\begin{enumerate}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \lit $\rf{CompletenessOfR}$ \pipe $\rf{LUBProperty}(\mathbb{R}, <)$
    \lit $\pr{\rf{LUBProperty}(\mathbb{R}, <)} \land (\emptyset \neq E \subset \mathbb{R}) \land \pr{\rf{BoundedAbove}(E, \mathbb{R}, <)}$ \pipe $\exists_{y \in \mathbb{R}}\pr{\rf{LUB}(y, E, \mathbb{R}, <)}$ \cont
    \lit \cont $y_0 \abr choice\pr{\{y \in \mathbb{R} | \rf{LUB}(y, E, \mathbb{R}, <)\}}$ \pipe $\rf{LUB}(y_0, E, \mathbb{R}, <)$
    \lit $\pr{\rf{LUB}(y_0, E, \mathbb{R}, <)} \land (t_0 \in E) \land (t_0 > 0)$ \pipe $0 < t_0 \leq y_0$ \pipe $y_0 > 0$
    ...
    \begin{enumerate}
      ...
      \lit $\rf{RootLemma1} \land (0 < y_0 < y_0 + h_0)$ \pipe $(y_0 + h_0)^n - {y_0}^n < h_0 n (y_0 + h_0)^{n - 1}$
    ...
    \lit ${y_0}^n > x \implies \ldots$ 123123
    \begin{enumerate}
      ...
      \lit $\rf{LUB}(y_0, E, \mathbb{R}, <)$ \pipe $\forall_{z \in \mathbb{R}}\pr{z < y_0 \implies \lnot \rf{UpperBound}(z, E, \mathbb{R}, <)}$
    ...
    \lit $\exists_{y \in \mathbb{R}}(y^n = x) \land \forall_{a, b \in \mathbb{R}}\pr{(a^n = x \land b^n = x) \implies a = b}$ \pipe $\exists!_{y \in \mathbb{R}}(y^n = x)$
  \end{enumerate}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
TODO:
- CALL WFFS DEFINITION BUT ABREVIATING ONLY WFF/RELATIONS AND NOT TERMS OR FUNCTIONS
...
$RowEquivalent(A, B) \abr \exists_{\Phi}\pr{\forall_{\phi \in \Phi}\pr{ElementaryRowOperation(\phi)} \land |\Phi| \in \mathbb{N} \land \Phi(A) = B}$ \\

By Gauss-Jordan Elimination: $NonZero(A) \implies \exists_{B}\pr{RREF(B) \land RowEquivalent(A, B)}$ \\
