...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
      ...
      \begin{enumerate}
        \lit $s \in \beta$ \pipe $\exists_{r > 0}(-s - r \notin \alpha)$ \pipe $r_2 \abr choice(\{r > 0 | -s - r \notin \alpha\})$
        \lit $r_2 > 0$ \pipe $-s - r_2 < -s + r_2 - r_2 = -s$ \pipe $-s - r_2 < -s$
        \lit $\alpha \in \mathbb{R} \land -s -r_2 \notin \alpha \land -s - r_2 < -s$ \pipe $-s \notin \alpha$ \pipe
        \lit $-s - r_2 < -s$
        \lit $\beta \in \mathbb{R} \land $
        \lit since b in R, use cut corollary
        \lit ...
        \lit dont fuck up r with r_2
      \end{enumerate}
      \lit $(r \in \alpha \land s \in \beta) \implies \ldots$
    \end{enumerate}
