...
$CosetMul[\bbin{*}, H, G, *] \abr (Subgroup[H, G, *]) \land (\forall_{x, y \in G}(H x \bbin{*} H y = \{h_1 x h_2 y | h_1, h_2 \in H\}))$ \\
...
$FirstIsoTheorem \abr (Homomorphism[\phi, G, *, H, \diamond]) \implies (Isomorphic[G / ker_\phi, \bbin{*}, im_\phi, \diamond])$
\begin{enumerate}
...
$SecondIsoTheorem \abr ((Subgroup[H, G, *]) \land (NormalSubgroup[N, G, *])) \implies (Isomorphic[(H N) / N, \bbin{*}, H / (H \cap N), \bbin{*}])$
\begin{enumerate}
  \lit TODO
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 

$ThirdIsoTheorem \abr ((NormalSubgroup[K, G, *]) \land (NormalSubgroup[H, G, *]) \land (Subgroup[K, H, *])) \implies (Isomorphic[G / H, \bbin{*}, (G / K) / (H / K), \bbin{*}])$
\begin{enumerate}
  \lit TODO
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
