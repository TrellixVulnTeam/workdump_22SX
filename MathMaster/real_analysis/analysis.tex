...
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
CONTHERE
$HomoCompInduceHomo \abr ((Homomorphism[\phi, G, *, H, \diamond]) \land (Homomorphism[\theta, H, \diamond, K, \mathbin{\square}])) \implies (Homomorphism[\theta \circ \phi, G, *, K, \mathbin{\square}])$
\begin{enumerate}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    \lit $(ExpModOrder) \land (Order[n, G, *]) \land (Order[n, H, \diamond])$ \pipe $(g^{n_1} = g^{n_2}) \iff (n_1 \equiv n_2 (mod \phantom{.} n)) \iff (h^{n_1} = h^{n_2}) \iff (\phi(g^{n_1}) = \phi(g^{n_2}))$ \pipe $(g^{n_1} = g^{n_2}) \iff (\phi(g^{n_1}) = \phi(g^{n_2}))$
  \end{enumerate}
  ...
  \lit TODO: $Homomorphism[\phi, G, *, H, \diamond]$
  \lit $(Homomorphism[\phi, G, *, H, \diamond]) \land (Bij[\phi, G, H])$ \pipe $Isomorphism[\phi, G, *, H, \diamond]$
