...
$NaturalMap[\bar{\phi}, H, G, *] \abr (NormalSubgroup[H, G, *]) \land (Func[\bar{\phi}, G, *, G / H, \bbin{*}]) \land (\forall_{g \in G}(\bar{\phi}(g) = H g))$ \\
...
$FirstIso[\psi, \phi, G, *, H, \diamond] \abr (Homomorphism[\phi, G, *, H, \diamond]) \land (\psi = \{\langle ker_\phi g, \phi(g) \rangle \in (G / ker_\phi \times im_\phi) \st g \in G\})$ \\

$FirstIsoThm \abr (Homomorphism[\phi, G, *, H, \diamond]) \implies (Isomorphic[G / ker_\phi, \bbin{*}, im_\phi, \diamond])$
\begin{enumerate}
  \lit $FirstIso[\psi, \phi, G, *, H, \diamond]$
...
$SecondIso[\psi, \phi, G, *, H, \diamond] \abr (Subgroup[H, G, *]) \land (NormalSubgroup[N, G, *]) \land (\psi = ...)$ \\
...
$ThirdIso[\psi, \phi, G, *, H, \diamond] \abr (NormalSubgroup[K, G, *]) \land (NormalSubgroup[H, G, *]) \land (Subgroup[K, H, *]) \land (\psi = ...)$ \\
...
% TODO CREATE ALL FOUR NATURAL MAPS!!!!!!!
% TODO FORMALIZE ALL ISOMORPHIC MAPS OF THE ISOMORPHISM THEOREMS!!!
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
