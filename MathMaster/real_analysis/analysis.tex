...
\wff{Field+R} $\rf{Field^+}(\mathbb{R})$ TODO: SPLITUP
\begin{enumerate}
  \lit $(\alpha, \beta \in \mathbb{R}) \implies \ldots$
  \begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
      ...
      \lit $\alpha +_{\mathbb{R}} \beta \subseteq 0_{\mathbb{R}} \land 0_{\mathbb{R}} \subseteq \alpha +_{\mathbb{R}} \beta$ \pipe $\alpha +_{\mathbb{R}} \beta = 0_{\mathbb{R}}$ \pipe $\exists_{-\alpha \in \mathbb{R}}(\alpha + (-\alpha) = 0_{\mathbb{R}})$
    \end{enumerate}
