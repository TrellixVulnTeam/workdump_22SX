...
$\df{<R}(\alpha, \beta) \abr \alpha, \beta \in \mathbb{R} \land \alpha \subset \beta$ \\

\wff{OrderTrichotomyR} $\rf{OrderTrichotomy}(\mathbb{R}, \rf{<R})$
\begin{enumerate}
  \lit $(\alpha, \beta \in \mathbb{R}) \implies \ldots$
  \begin{enumerate}
    \lit $\lnot(\alpha <R \beta \lor \alpha = \beta) \implies \ldots$
    \begin{enumerate}
      \lit $\alpha \not \subset \beta \land \alpha \neq \beta$    \ann{\rf{<R}, 1.1}{}
    \end{enumerate}
    \lit $\lnot(\alpha <R \beta \lor \alpha = \beta) \implies \beta <R \alpha$
  \end{enumerate}
  \lit $(\alpha, \beta \in \mathbb{R}) \implies (\alpha <R \beta \veebar \alpha = \beta \veebar \alpha <R \beta)$
  \lit $\forall_{\alpha, \beta \in \mathbb{R}}(\alpha <R \beta \veebar \alpha = \beta \veebar \alpha <R \beta)$
  \lit $\rf{OrderTrichotomy}(\mathbb{R}, \rf{<R})$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\

\wff{OrderTransitivityR} $\rf{OrderTransitivity}(\mathbb{R}, \rf{<R})$
\begin{enumerate}
  \lit $(\alpha, \beta, \gamma \in \mathbb{R}) \implies \ldots$
  \begin{enumerate}
    \lit 123123
  \end{enumerate}
  \lit $(\alpha, \beta, \gamma \in \mathbb{R}) \implies \pr{(\alpha <R \beta \land \beta <R \gamma) \implies \alpha <R \gamma}$
  \lit $\forall_{\alpha, \beta, \gamma \in \mathbb{R}}\pr{(\alpha <R \beta \land \beta <R \gamma) \implies \alpha <R \gamma}$
  \lit $\rf{OrderTransitivity}(\mathbb{R}, \rf{<R})$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\

\wff{OrderR} $\rf{Order}(<R, \mathbb{R})$    \phantom{TODO}--- \\
