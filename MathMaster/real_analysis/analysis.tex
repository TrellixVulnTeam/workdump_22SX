...
(1.21) \\
\wff{RootLemma} $(0 < a < b) \implies b^n - a^n \leq (b - a) n b^{n - 1}$
\begin{enumerate}
...
\wff{Root} $\forall_{0 < x \in \mathbb{R}} \forall_{0 < n \in \mathbb{Z}} \exists!_{0 < y \in \mathbb{R}}(y^n = x)$
\begin{enumerate}
  ...
  \begin{enumerate}
    \lit $k_0 \abr \frac{x - y^n}{n (y + 1)^{n - 1}}$ \pipe $k \in \mathbb{R}$
    \lit $y^n < x$ \pipe $0 < x - y^n$
    \lit $n > 0 \land y > 0$ \pipe $0 < n (y + 1)^{n - 1}$ \pipe $0 < \frac{x - y^n}{n (y + 1)^{n - 1}} = k_0$ \pipe $0 < k_0$
    \lit $0, 1, k_0 \in \mathbb{R} \land (0 < 1 \land 0 < k_0)$ \pipe $\exists_{h \in \mathbb{Q}}(0 < h < min(1, k_0))$ \pipe $h_0 \abr choice(\{h \in \mathbb{Q} | 0 < h < min(1, k_0)\})$
