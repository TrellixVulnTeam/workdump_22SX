...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \lit $\rf{BoundedAbove}(A, \mathbb{R}, <)$ \pipe $\exists_{\beta}\pr{\rf{UpperBound}(\beta, A, \mathbb{R}, <)}$
    \lit $\beta_0 \abr choice(\{\beta | \rf{UpperBound}(\beta, A, \mathbb{R}, <)\})$
    \lit $\rf{UpperBound}(\beta_0, A, \mathbb{R}, <)$ \pipe $\forall_{\alpha \in A}(\alpha \leq \beta_0)$ \pipe $\forall_{\alpha \in A}(\alpha \subseteq \beta_0)$
    \lit $\forall_{\alpha \in A} \forall_{a \in \alpha}(a \in \beta_0)$ \pipe $\forall_{a \in \gamma}(a \in \beta_0)$ \pipe $\gamma \subseteq \beta_0$
    ...
    \lit $\forall_{\alpha \in A}(\alpha \subseteq \gamma)$ \pipe $\forall_{\alpha \in A}(\alpha \leq \gamma)$ \pipe $\rf{UpperBound}(\gamma, A, \mathbb{R}, <)$
    \lit $\delta < \gamma \implies \ldots$
    \begin{enumerate}
      ...
      \lit $\delta \geq \alpha_3 \implies \ldots$
      \begin{enumerate}
      ...
      \end{enumerate}
      \lit $\delta \geq \alpha_3 \implies \bot$ \pipe $\delta < \alpha_3$ \pipe $\exists_{\alpha \in A}(\delta < \alpha)$ \pipe $\exists_{\alpha \in A}\pr{\lnot(\alpha \leq \delta)}$
      \lit $\lnot \forall_{\alpha \in A}(\alpha \leq \delta)$ \pipe $\lnot \rf{UpperBound}(\delta, A, \mathbb{R}, <)$
    \end{enumerate}
    \lit $\delta < \gamma \implies \lnot \rf{UpperBound}(\delta, A, \mathbb{R}, <))$ \pipe $\forall_{\delta}\pr{\delta < \gamma \implies \lnot \rf{UpperBound}(\delta, A, \mathbb{R}, <)}$
    \lit $\rf{UpperBound}(\gamma, A, \mathbb{R}, <) \land \forall_{\delta}\pr{\delta < \gamma \implies \lnot \rf{UpperBound}(\delta, A, \mathbb{R}, <)}$ \pipe $\rf{LUB}(\delta, A, \mathbb{R}, <)$
  \end{enumerate}  
  \lit $\pr{\emptyset \neq A \subset \mathbb{R} \land \rf{BoundedAbove}(A, \mathbb{R}, <)} \implies \exists_{\gamma \in S}\pr{\rf{LUB}(\gamma, A, \mathbb{R}, <)}$
  \lit $UNIVERSAL CLOSURE$
  \lit $\rf{LUBProperty}(\mathbb{R}, <)$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\
