...
$CosetMul[\bbin{*}, H, G, *] \abr (Subgroup[H, G, *]) \land \pr{\forall_{x, y \in G}(H x \bbin{*} H y = \{h_1 x h_2 y | h_1, h_2 \in H\})}$ \\
...
$SecondIsoTheorem \abr \pr{(Subgroup[H, G, *]) \land (NormalSubgroup[N, G, *])} \implies \pr{Isomorphic[(H N) / N, \bbin{*}, H / (H \cap N), \bbin{*}]}$
\begin{enumerate}
  \lit TODO
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 

$ThirdIsoTheorem \abr \pr{(NormalSubgroup[K, G, *]) \land (NormalSubgroup[H, G, *]) \land (Subgroup[K, H, *])} \implies \pr{Isomorphic[G / H, \bbin{*}, (G / K) / (H / K), \bbin{*}]}$
\begin{enumerate}
  \lit TODO
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
