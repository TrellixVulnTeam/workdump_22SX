...
$QuotientMap[\bar{\phi}, H, G, *] \abr (NormalSubgroup[H, G, *]) \land (Func[\bar{\phi}, G, *, G / H, \bar{*}]) \land \pr{\forall_{g \in G}\pr{\bar{\phi}(g) = H g}}$ \\
...
\begin{enumerate}
  ...
  \end{enumerate}
  \lit $(x, y \in G) \implies \pr{\bar{\phi}(x * y) = \bar{\phi}(x) \bar{*} \bar{\phi}(y)}$ \pipe $\forall_{x, y \in G}\pr{\bar{\phi}(x) \bar{*} \bar{\phi}(y)})$
  \lit $(Func[\bar{\phi}, G, *, G / H, \bar{*}]) \land \pr{\forall_{x, y \in G}\pr{\bar{\phi}(x) \bar{*} \bar{\phi}(y)}})$ \pipe $Homomorphism[\bar{\phi}, G, *, G / H, \bar{*}]$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\
