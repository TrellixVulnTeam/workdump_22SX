...
\begin{enumerate}
  ...
  \begin{enumerate}
    \lit $u \in S'$ \pipe $\exists_{K \in \mathbb{R}^n}(LinComb[u, S, K, V, +, *])$ \pipe $\exists_{K \in \mathbb{R}^n}\pr{u = \sum_{i = 1}^{n}(k_i * s_i)}$
    \lit $v \in S'$ \pipe $\exists_{L \in \mathbb{R}^n}(LinComb[v, S, L, V, +, *])$ \pipe $\exists_{L \in \mathbb{R}^n}\pr{v = \sum_{i = 1}^{n}(l_i * s_i)}$
    ...
    \lit $\exists_{M \in \mathbb{R}^n}\pr{u + v = \sum_{i = 1}^{n}(m_i * s_i)}$ \pipe $\exists_{M \in \mathbb{R}^n}(LinComb[u + v, S, M, V, +, *])$ \pipe $u + v \in S'$
  \end{enumerate}
...
$LinInd[S, V, +, *] \abr (VectorSpace[V, +, *]) \land (\emptyset \neq S \in V^n) \land \pr{\forall_{K \in \mathbb{R}^n}\pr{(LinComb[O, S, K, V, +, *]) \implies (K = \{0\}^n)}}$ \\
