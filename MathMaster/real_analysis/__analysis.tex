...
\begin{enumerate}
  ...
  \begin{enumerate}
    \lit $(LinComb[\alpha, A, K_\alpha, V, +_v, *_v]) \land (LinComb[\beta, A, K_\beta, V, +_v, *_v])$ \pipe $\pr{\alpha = \sum_{i = 1}^{n}({k_\alpha}_i * a_i)} \land \pr{\beta = \sum_{i = 1}^{n}({k_\beta}_i * a_i)}$
  ...
  \begin{enumerate}
    \lit $LinComb[\alpha, A, K, V, +_v, *_v]$ \pipe $\alpha = \sum_{i = 1}^{n}(k_i * a_i)$
