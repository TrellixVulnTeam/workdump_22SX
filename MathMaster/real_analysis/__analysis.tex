...
$NaturalMap[\bar{\phi}, H, G, *] \abr (NormalSubgroup[H, G, *]) \land (Func[\bar{\phi}, G, *, G / H, \bbin{*}]) \land \pr{\forall_{g \in G}\pr{\bar{\phi}(g) = H g}}$ \\
...
$FirstIso[\psi, \phi, G, *, H, \diamond] \abr (Homomorphism[\phi, G, *, H, \diamond]) \land \pr{\psi = \{\langle ker_\phi g, \phi(g) \rangle \in (G / ker_\phi \times im_\phi) \st g \in G\}}$ \\
...
\begin{enumerate}
  ...
  \lit $\phi \abr \{\langle h, h N \rangle \in \pr{H \times (H N) / N} \st h \in H\}$
  ...
  \lit $(FirstIsoThm) \land \pr{Homomorphism[\phi, H, *, (H N) / N, \bbin{*}]}$ \pipe $Isomorphic[H / ker_\phi, \bbin{*}, im_\phi, \bbin{*}]$
...
\end{array}\right)$
\begin{enumerate}
  \lit $\phi \abr \{\langle g K, g H \rangle \in \pr{(G / K) \times (G / H)} \st g \in G\}$
