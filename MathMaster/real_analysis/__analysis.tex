...
\begin{enumerate}
  ...
  \begin{enumerate}
    \lit $\pr{\phi(a) = e_H} \land \pr{\phi(b) = e_H}$ \pipe $e_H = e_H \diamond e_H = \phi(a) \diamond \phi(b) = \phi(a * b)$ \pipe $a * b \in ker_\phi$
  \end{enumerate}
...
\begin{enumerate}
  ...
  \end{enumerate}
  \lit $\pr{\phi(x) = \phi(g)} \implies \pr{x \in (ker_\phi) g}$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 

$MapsToSameElMultiplicity \abr \pr{(|G| = n) \land (|ker_\phi| = m) \land (|im_\phi| = r)} \implies (n = m r)$
\begin{enumerate}
  \lit TODO
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 

$ImageDividesGH \abr (|im_\phi| = r) \implies \pr{\pr{Divides[r, o(G)]} \land \pr{Divides[r, o(H)]}}$
\begin{enumerate}
...
$ConjugateOrder \abr (h \sim^* g) \implies \pr{o(h) = o(g)}$
\begin{enumerate}
