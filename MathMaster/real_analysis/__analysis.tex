...
$RowOp(\phi, A) \abr \pr{\phi \equiv RowSwap(A)} \lor \pr{\phi \equiv RowScale(A)} \lor \pr{\phi \equiv RowCombine(A)}$ \\
$RowOps(\langle \Phi \rangle_1^n, A) \abr \forall_{i < n}\pr{\pr{(i = 1) \implies RowOp(\phi_i, A)} \land \pr{(i > 1) \implies RowOps(\langle \Phi \rangle_i^n), \phi_i(A)}}$ \\
$RowEquiv(A, B) \abr \exists_{\langle \Phi \rangle_1^n}\pr{\pr{RowOps(\langle \Phi \rangle_1^n, A)} \land \pr{\langle \Phi \rangle_1^n(A) = B}}$ \\
