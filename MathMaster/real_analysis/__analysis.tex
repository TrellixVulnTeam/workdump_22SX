...
$KerCountsMapSameEl \abr \pr{(Homomorphism[\phi, G, *, H, \diamond]) \land (g \in G)} \implies \pr{(ker_\phi) g = \{x \in G \st \phi(x) = \phi(g)\}}$
\begin{enumerate}
  ...
  \end{enumerate}
  \lit $\pr{\phi(x) = \phi(g)} \implies \pr{x \in (ker_\phi) g}$ \pipe $\{x \in G \st \phi(x) = \phi(g)\} \subseteq (ker_\phi) g$
...
\begin{enumerate}
  ...
  \lit $\pr{g H \in (G / H)} \implies \ldots$
  \begin{enumerate}
    \lit $g \in G$ \pipe $g K \in (G / K)$
    \lit $g H = \phi(g K)$
    \lit $\pr{g K \in (G / K)} \land \pr{g H = \phi(g K)}$ \pipe $\exists_{g K \in (G / K)}\pr{g H = \phi(g K)}$
  \end{enumerate}
  \lit $\pr{g H \in (G / H)} \implies \pr{\exists_{g K \in (G / K)}\pr{g H = \phi(g K)}}$ \pipe $\forall_{g H \in (G / H)} \exists_{g K \in (G / K)}\pr{g H = \phi(g K)}$ \pipe $Surj[\phi, G / K, G / H]$ \pipe $im_\phi = G / H$
