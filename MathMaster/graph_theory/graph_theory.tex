...
$G \abr
\left(\begin{array}{ll}
  (((n(G) \leq 2 k + 1) \land (CompletekPartite[G, k])) \land (\chi_l(G) > \chi(G) = k)) \hfill \land \hfill \\
  (\forall_{G'}(((n(G') < n(G)) \land (n(G') \leq 2 \chi(G') + 1)) \implies (ChromaticChoosable[G'])))
\end{array}\right)$ \\
$L \abr ((ListAssignment[L, G]) \land (\forall_{v \in V(G)}(|L(v)| = k))) \land (\lnot LColorable[G, L])$ \\
$C \abr TotalColors[C, L, G]$ \\

$PartialLAcceptableColoring[g, L, G, A] \abr (\emptyset \neq A \subseteq V(G)) \land (LAcceptableColoring[g, L, G[A]])$ \\
