...
$Walk[W_n, n] \abr (V = \{x_i \st i \in \mathbb{N}_1^{n + 1}\}) \land (E = \{\{x_i, x_{i+1}\} \st i \in \mathbb{N}_1^n\})$ \\
...
%$Isomorphic[H, G] \abr \exists_{\phi}\pr{\pr{Bijection[\phi, V(H), V(G)]} \land \pr{\forall_{x, y \in V(H)}\pr{\{x, y\} \in E(H) \iff \{\phi(x), \phi(y)\} \in E(G)}}}$ \\
