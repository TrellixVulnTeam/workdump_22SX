...
$Tree[G] \abr (Connected[G]) \land \pr{\not \exists_{n, V_n}(Cycle[V_n, n, G])}$ \\
...
%$Join[E_G(U, W), U, W, G] \abr \pr{U, W \subseteq V(G)} \land (U \cap W = \emptyset) \land \pr{E_G(U, W) = \{e \st \exists_{u \in U} \exists_{w \in W}(Incident[e, u, w, G])\}}$ \\
%$JoinSize[e_G(U, W), U, W, G] \abr \pr{Join[E_G(U, W), U, W, G]} \land \pr{e_G(U, W) = |E_G(U, W)|}$ \\


%$SizeOrderN \abr \pr{(n = |G|) \land \pr{m = e(G)}} \implies \pr{0 \leq m \leq {n \choose 2} = \frac{(n-1) (n)}{2}}$ \\
