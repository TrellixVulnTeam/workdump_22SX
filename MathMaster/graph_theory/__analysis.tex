...
$BipartiteEquiv \abr (Bipartite[G]) \iff \pr{\lnot \exists_{C}\pr{(CycleG[C]) \land (Subgraph[C, G]) \land (OddWalk[C, G])}}$
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \lit $\lnot \exists_{C}\pr{(CycleG[C]) \land (Subgraph[C, G]) \land (OddWalk[C, G])}$
  \end{enumerate}
  \lit $(Bipartite[G]) \implies \pr{\lnot \exists_{C}\pr{(CycleG[C]) \land (Subgraph[C, G]) \land (OddWalk[C, G])}}$
  \lit $\pr{\lnot \exists_{C}\pr{(CycleG[C]) \land (Subgraph[C, G]) \land (OddWalk[C, G])}} \implies \ldots$
  \begin{enumerate}
  ...
  \end{enumerate}
  \lit $\pr{\lnot \exists_{C}\pr{(CycleG[C]) \land (Subgraph[C, G]) \land (OddWalk[C, G])}} \implies (Bipartite[G])$
  \lit $(Bipartite[G]) \iff \pr{\lnot \exists_{C}\pr{(CycleG[C]) \land (Subgraph[C, G]) \land (OddWalk[C, G])}}$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
