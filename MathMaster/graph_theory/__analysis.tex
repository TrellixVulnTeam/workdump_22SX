...
$Path[G] \abr \exists_{P}\pr{\pr{Ordering[P, V(G)]} \land \pr{E(G) = \{\utup{p_i, p_{i + 1}} \st i \in \mathbb{N}_1^{|P| - 1}\}}}$ \\
$Cycle[G] \abr \exists_{C}\pr{\pr{Ordering[C, V(G)]} \land \pr{E(G) = \{\utup{c_i, c_{i + 1}} \st i \in \mathbb{N}_1^{|C| - 1}\} \cup \{c_n, c_1\}}}$ \\

$Subgraph[H, G] \abr \pr{V(H) \subseteq V(G)} \land \pr{E(H) \subseteq E(G)}$ \\
$ConnectedV[\{x, y\}, G] \abr \exists{H}\pr{(Subgraph[H, G]) \land (Path[H]) \land \pr{\{x, y\} \subseteq V(H)}}$ \\
...
$Girth[G] \abr min\pr{\{n \in \mathbb{N} \st \exists_{V_n}(CycleG[V_n, n, G])\}}$ \\
$Circumference[G] \abr max\pr{\{n \in \mathbb{N} \st \exists_{V_n}(CycleG[V_n, n, G])\}}$ \\
