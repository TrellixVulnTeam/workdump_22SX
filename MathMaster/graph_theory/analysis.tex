...
$Adjacent[x, y, G] \abr (Graph[G]) \land (\{x, y\} \in E(G))$ \\
$Incident[e, x, y, G] \abr (Graph[G]) \land (e = \{x, y\} \in E(G))$ \\
$SimpleGraph[(V, E)] \abr (Graph[(V, E)]) \land (E \subseteq \{\{a, b\} \in V^{\{2\}} \st a \neq b\})$ \\
$Subgraph[H, G] \abr (Graph[H]) \land (Graph[G]) \land (V(H) \subseteq V(G)) \land (E(H) \subseteq E(G))$ \\
$SpanningSubgraph[H, G] \abr (Subgraph[H, G]) \land (V(H) = V(G))$ \\
$RestrictionV[G[V'], V', G] \abr (Graph[G]) \land (G[V'] = (V', \{e \in E(G) \st \exists_{a, b \in V'}(e = \{a, b\})\}))$ \\
$InducedSubgraph[H, G] \abr (Subgraph[H, G]) \land (RestrictionV[H, V(H), G])$ \\
$RemoveV[G - v, v, G] \abr (Graph[G]) \land (v \in V(G)) \land (RestrictionV[G - v, V(G) \setminus \{v\}, G])$ \\
$RemoveE[G - e, e, G] \abr (Graph[G]) \land (e \in E(G)) \land (G - e = (V(G), E(G) \setminus \{e\}))$ \\
$AddE[G + e, e, G] \abr (Graph[G]) \land (e \notin E(G)) \land (e \in V(G)^{\{2\}}) \land (G + e = (V(G), E(G) \cup \{e\}))$ \\
$Order[|G|, G] \abr (Graph[G]) \land (|G| = |V(G)|$ \\
$Size[e(G), G] \abr (Graph[G]) \land (e(G) = |E(G))|$ \\
