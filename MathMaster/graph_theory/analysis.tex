...
$Complement[\bar{G}, G] \abr (V = V(G)) \land (E = \{\utup{a, b} \in V^{\{2\}} \st (a \neq b) \land (\utup{a, b} \notin E(G))\}) \land (\bar{G} = (V, E))$ \\
...
$Tree[G] \abr (Connected[G]) \land (\not \exists_{n, V_n}(Cycle[V_n, n, G]))$ \\
...
%$Join[E_G(U, W), U, W, G] \abr (U, W \subseteq V(G)) \land (U \cap W = \emptyset) \land (E_G(U, W) = \{e \st \exists_{u \in U} \exists_{w \in W}(Incident[e, u, w, G])\})$ \\
%$JoinSize[e_G(U, W), U, W, G] \abr (Join[E_G(U, W), U, W, G]) \land (e_G(U, W) = |E_G(U, W)|)$ \\


%$SizeOrderN \abr ((n = |G|) \land (m = e(G))) \implies (0 \leq m \leq {n \choose 2} = \frac{(n-1) (n)}{2})$ \\
