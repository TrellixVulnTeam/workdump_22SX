...
$kColorable[G, k] \abr \exists_{\phi}((ProperColoring[\phi, G]) \land (kColoring[\phi, k, G]))$ \\
$ChromaticNumber[\chi(G), G] \abr min(\{k \in \mathbb{N} \st kColorable[G, k]\})$ \\

$ColorAssignment[L, G] \abr Function[L, V(G), \mathcal{P}(\mathbb{N})]$ \\
$LColoring[\phi, L, G] \abr (Coloring[\phi, G]) \land (ColorAssignment[L, G]) \land (\forall_{v \in V(G)}(\phi(v) \in L(v))$ \\
$LColorable[G, L] \abr \exists_{\phi}((ProperColoring[\phi, G]) \land (LColoring[\phi, L, G]))$ \\
$kChoosable[G, k] \abr \forall_{L}(((ColorAssignment[L, G]) \land (\forall_{v \in V(G)}(|L(v)| = k))) \implies (LColorable[G, L]))$ \\
...
$OhbaEquiv \abr ((CompletekPartite[G, k]) \land (n(G) \leq 2 k + 1)) \implies (\chi_l(G) = \chi(G) = k)$ \\
