...
$Path[G] \abr \exists_{P}((Ordering[P, V(G)]) \land (E(G) = \{\utup{p_i, p_{i + 1}} \st i \in \mathbb{N}_1^{|P| - 1}\}))$ \\
$Cycle[G] \abr \exists_{C}((Ordering[C, V(G)]) \land (E(G) = \{\utup{c_i, c_{i + 1}} \st i \in \mathbb{N}_1^{|C| - 1}\} \cup \{c_n, c_1\}))$ \\

$Subgraph[H, G] \abr (V(H) \subseteq V(G)) \land (E(H) \subseteq E(G))$ \\
$ConnectedV[\{x, y\}, G] \abr \exists{H}((Subgraph[H, G]) \land (Path[H]) \land (\{x, y\} \subseteq V(H)))$ \\
...
$Girth[G] \abr min(\{n \in \mathbb{N} \st \exists_{V_n}(CycleG[V_n, n, G])\})$ \\
$Circumference[G] \abr max(\{n \in \mathbb{N} \st \exists_{V_n}(CycleG[V_n, n, G])\})$ \\
