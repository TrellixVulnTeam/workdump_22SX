...
$PathContainsWalk[P, W, G] \abr (VPath[P, G]) \land (VWalk[W, G]) \land \exists_{\phi}((OrderedDeletion[\phi, W]) \land (P = \phi(W)))$ \\
...
$xyWalkInxyPath \abr (xyWalk[(x, y), W, G]) \implies (\exists_{P}((xyPath[(x, y), P, G]) \land (PathContainsWalk[P, W, G])))$
\begin{enumerate}
  \lit $(l(W) = 0) \implies (P = W)$ \pipe $PathContainsWalk[P, W, G]$
  \lit $((l(W) > 0) \land (\forall_{W'}((l(W') < l(W)) \implies \\
        ((xyWalk[(x, y), W', G]) \implies (\exists_{P'}((xyPath[(x, y), P', G]) \land (PathContainsWalk[P', W', G]))))))) \implies \ldots$
  \begin{enumerate}
    \lit If W has no duplicate vertices, then P = W \pipe $PathContainsWalk[P, W, G]$
    \lit If W has duplicate vertices, then delete the duplicate vertices and edges between extra copies of unique vertices. This shorter xyWalk W' has a xyPath P' by IH. \pipe $PathContainsWalk[P', W, G]$
  \end{enumerate}
  \lit $((l(W) > 0) \land (\forall_{W'}((l(W') < l(W)) \implies \\
  ((xyWalk[(x, y), W', G]) \implies (\exists_{P'}((xyPath[(x, y), P', G]) \land (PathContainsWalk[P', W', G]))))))) \implies (PathContainsWalk[P, W, G])$
  \lit By induction: $(xyWalk[(x, y), W, G]) \implies (\exists_{P}((xyPath[(x, y), P, G]) \land (PathContainsWalk[P, W, G])))$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
...
% IndependentSet iff E(G[S]) = \emptyset 
...
% ClosedEvenWalk with a unique edge can construct a cycle via xyWalkInxyPath

$Bipartiton[\{X, Y\}, G] \abr PartiteSets[\{X, Y\}, G]$ \\
$ConnectedBipartite[G] \abr \exists!_{\{X, Y\}}(Bipartiton[\{X, Y\}, G])$ \\

$BipartiteEquiv \abr (Bipartite[G]) \iff (\lnot \exists_{C}((CycleG[C]) \land (Subgraph[C, G]) \land (VOdd[C, G])))$
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \lit $\lnot \exists_{C}((CycleG[C]) \land (Subgraph[C, G]) \land (VOdd[C, G]))$
  \end{enumerate}
  \lit $(Bipartite[G]) \implies (\lnot \exists_{C}((CycleG[C]) \land (Subgraph[C, G]) \land (VOdd[C, G])))$
  \lit $(\lnot \exists_{C}((CycleG[C]) \land (Subgraph[C, G]) \land (VOdd[C, G]))) \implies \ldots$
  \begin{enumerate}
    ...
    \begin{enumerate}
      ...
      \lit By $OddCycleInClosedOddWalk$, there exists an odd cycle in $G$. \pipe $\bot$
    \end{enumerate}
    \lit $X$ and $Y$ are independent sets; futhermore X, Y are bipartitions of G. \pipe $Bipartite[G]$
  \end{enumerate}
  \lit $(\lnot \exists_{C}((CycleG[C]) \land (Subgraph[C, G]) \land (VOdd[C, G]))) \implies (Bipartite[G])$
  \lit $(Bipartite[G]) \iff (\lnot \exists_{C}((CycleG[C]) \land (Subgraph[C, G]) \land (VOdd[C, G])))$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
...
$CompleteAsBipartiteUnion \abr (\exists_{\mathcal{B}}((|\mathcal{B}| = k) \land (\forall_{B \in \mathcal{B}}(BipartiteG[B])) \land (UnionG[K_n, \mathcal{B}]))) \iff (n \leq 2^k)$
\begin{enumerate}
  \lit $(k = 1) \implies \ldots$
  \begin{enumerate}
    \lit $(\exists_{\mathcal{B}}((|\mathcal{B}| = k) \land (\forall_{B \in \mathcal{B}}(BipartiteG[B])) \land (UnionG[K_n, \mathcal{B}]))) \iff (Bipartite[K_n])$
    ...
    \lit $(Bipartite[K_n]) \iff (n \leq 2)$ \pipe $(\exists_{\mathcal{B}}((|\mathcal{B}| = k) \land (\forall_{B \in \mathcal{B}}(BipartiteG[B])) \land (UnionG[K_n, \mathcal{B}]))) \iff (n \leq 2)$
  \end{enumerate}
  \lit $(k = 1) \implies ((\exists_{\mathcal{B}}((|\mathcal{B}| = k) \land (\forall_{B \in \mathcal{B}}(BipartiteG[B])) \land (UnionG[K_n, \mathcal{B}]))) \iff (n \leq 2))$
  \lit $((k > 1) \land (\forall_{k'}((k' < k) \implies ((\exists_{\mathcal{B}}((|\mathcal{B}| = k') \land (\forall_{B \in \mathcal{B}}(BipartiteG[B])) \land (UnionG[K_n, \mathcal{B}]))) \iff (n \leq 2^{k'}))))) \implies \ldots$
  \begin{enumerate}
    \lit THE SUBGRAPH INDUCED BY X AND Y ARE NECESSARILY COMPLETE!!!!!!!!!!!!
  \end{enumerate}
  \lit $((k > 1) \land (\forall_{k'}((k' < k) \implies ((\exists_{\mathcal{B}}((|\mathcal{B}| = k') \land (\forall_{B \in \mathcal{B}}(BipartiteG[B])) \land (UnionG[K_n, \mathcal{B}]))) \iff (n \leq 2^{k'}))))) \implies 123123$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\ 
