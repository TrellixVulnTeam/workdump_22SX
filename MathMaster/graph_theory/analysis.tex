...
\begin{enumerate}
  ...
  \lit Since $2 \leq d(u)$, then $u$ has at least two edges that are incident among the vertices in $P$. Thus, $\exists_{C}((Subgraph[C, G]) \land (CycleG[C]))$.
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\

$EulerianEquiv \abr (Components[\mathcal{H}, G]) \implies ((Eulerian[G]) \iff ((|\{H \st (H \in \mathcal{H}) \land (\lnot Trivial[H])\}| \leq 1) \land (EvenGraph[G])))$
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \lit $(|\{H \st (H \in \mathcal{H}) \land (\lnot Trivial[H])\}| \leq 1) \land (EvenGraph[G])$
  \end{enumerate}
  \lit $(Eulerian[G]) \implies ((|\{H \st (H \in \mathcal{H}) \land (\lnot Trivial[H])\}| \leq 1) \land (EvenGraph[G]))$
  \lit $((|\{H \st (H \in \mathcal{H}) \land (\lnot Trivial[H])\}| \leq 1) \land (EvenGraph[G])) \implies \ldots$
  \begin{enumerate}
  ...
  \end{enumerate}
  \lit $((|\{H \st (H \in \mathcal{H}) \land (\lnot Trivial[H])\}| \leq 1) \land (EvenGraph[G])) \implies (Eulerian[G])$
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\
