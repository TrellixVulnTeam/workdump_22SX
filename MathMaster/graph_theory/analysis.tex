...
$AdjacentE[(e_1, e_2), G] \abr \exists!_{x \in V(G)}((x \in e_1) \land (x \in e_2))$ \\
...
$SumDegrees \abr \sum_{v \in V(G)}(deg(v)) = 2 |E(G)|$ \\
\begin{enumerate}
  \lit $\sum_{v \in V(G)}(deg(v)) = \sum_{v \in V(G)}(|\{e \in E(G) | v \in e\}|) = 2 |E(G)|$ \\
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\

$HandshakingLemma \abr Even(|\{v \st Odd(deg(v))\}|)$ \\
\begin{enumerate}
  \lit SumDeg
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\

$Walk[V_n, n, G] \abr (V_n = \{v_i \in V(G) \st i \in \mathbb{N}_1^{n + 1}\}) \land (\forall_{i \in \mathbb{N}_1^n}(\utup{v_i, v_{i + 1}} \in E(G)))$ \\
$Path[V_n, n, G] \abr (Walk[V_n, n, G]) \land (\forall_{i, j \in \mathbb{N}_1^{n + 1}}((i \neq j) \implies (v_i \neq v_j)))$ \\
...
$Regular[G, r] \abr \forall_{v \in V(G)}(deg(v) = r)$ \\

$SumDeg \abr \sum_{v \in V(G)}(deg(v)) = 2 |E(G)|$ \\
\begin{enumerate}
  \lit $\sum_{v \in V(G)}(deg(v)) = \sum_{v \in V(G)}(|\{e \in E(G) | v \in e\}|) = 2 |E(G)|$ \\
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\

$OddDeg \abr Even(|\{v \st Odd(deg(v))\}|)$ \\
\begin{enumerate}
  \lit SumDeg
\end{enumerate} \vspace{.75mm} \hrule \vspace{.75mm} \ \\
...
$PathG[P_n, n] \abr (V = \{v_i \st i \in \mathbb{N}_1^n\}) \land (E = \{\utup{v_i, v_{i + 1}} \st i \in \mathbb{N}_1^{n - 1}\}) \land (P_n = (V, E))$ \\

$CycleG[C_n, n] \abr (V = V(P_n)) \land (E = E(P_n) \cup \{\utup{v_n, v_1}\}) \land (C_n = (V, E))$ \\
